  ...
  return (
    <div style={{ padding: 'var(--space-6) 32px 40px' }}>
      <div style={{ marginBottom: 'var(--space-6)' }}>
        <Link href="/results" style={{ fontSize: 12, color: 'var(--accent)', textDecoration: 'none' }}>
          ← Tracked pages
        </Link>
        <h1 style={{ fontSize: 'var(--text-xl)', fontWeight: 700, color: 'var(--text-primary)', margin: 'var(--space-2) 0' }}>
          Campaigns
        </h1>
